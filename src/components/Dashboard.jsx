...
function UniversityCard({ university, onUpdateStatus, onDelete, onSelectUniversity, onUpdateField, onSetFinalUniversity }) {
  ...
  return (
    <div className="university-card">
      ...
      <div className="card-actions">
        ...
        {/* Show "Set as Final Choice" button only for accepted universities */}
        {status === 'accepted' && onSetFinalUniversity && (
          <button
            onClick={() => onSetFinalUniversity(id)}
            className="btn"
            style={{
...
function UniversityGroup({ city, universities, onUpdateStatus, onDelete, onSelectUniversity, onUpdateField, onSetFinalUniversity }) {
  return (
      ...
      <div className="university-cards">
        {universities.map(university => (
          <UniversityCard
            ...
            onSetFinalUniversity={onSetFinalUniversity}
          />
        ))}
      </div>
    </div>
